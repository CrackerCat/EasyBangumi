...
import easybangumi.composeapp.generated.resources.info_moesnackbar_swipe
...
data class MoeSnackBarData @OptIn(ExperimentalResourceApi::class) constructor(
    ...
    val cancelLabel: Any = Res.string.cancel,
    ...
    Column(
                                ...
                                Row {
                                    it.onConfirm?.run {
                                        TextButton({
                                            ...
                                            Text(
                                                stringOrResource( it.confirmLabel),
                                            )
                                        }
                                    }
                                    it.onCancel?.run {
                                        TextButton({
                                            ...
                                            this(it)
                                        }) { Text(stringOrResource( it.cancelLabel)) }
                                    }
                                }
                            },
        ...
        if (moeSnackBarQueue.size > 0)
            Card(
                ...
                Text(
                    stringResource( Res.string.info_moesnackbar_swipe),
...
fun Any.moeSnackBar(
    ...
    cancelLabel: Any = Res.string.cancel,
